...
export const EQUIPMENT_IDS = Object.freeze({
  ...
  legendary: Object.freeze({
    ...
    thornmail: "thornmail",
    qianbianzhejiaxiu: "qianbianzhejiaxiu",
...
const RAW_ITEMS = [
  ...
  },
  {
    ...
    description: [
      ...
      "生命值 +70",
      "法力值 +200",
      "被动：每击杀 10 个敌方单位，获得 1 点法强（最多 800 层）。至少 10 层时获得速度 +20%。",
    ],
  },
  {
  ...
  },
  {
    ...
    stats: { arFlat: 30 },
    buildsFrom: [BASIC.clothArmor],
    effects: { thornsArmorRatio: 0.10, thornsHealArmorRatio: 0.10 },
    description: [
      "护甲 +30",
      "被动：受到攻击时，对攻击者反弹并治疗自身 10% 护甲的魔法伤害。",
    ],
  },
  {
    key: MID.wardensMail,
  ...
  },
  {
    ...
    effects: {
      percentCurrentHp: 0.10,
      percentMinDamage: 30,
      percentMaxDamageNonBoss: 500,
      percentMaxDamageBoss: 800,
    },
    description: [
      "攻击力 +25",
      "攻速% +35%",
      "物理吸血 +10%",
      "破败打击：普攻附带相当于目标当前生命值的 10% 的物理伤害攻击特效，对所有单位至少造成 30 点额外伤害，对非 Boss 敌人最多造成 500 点额外伤害，对 Boss 最多造成 800 点额外伤害。",
    ],
  },
  {
    key: LEGENDARY.lingfeng,
    tier: ITEM_TIERS.LEGENDARY,
    name: "灵风",
    intro: "移速转攻速",
    tags: ["速度", "攻速"],
    ...
    iconFile: "灵风.png",
    cost: 2850,
    stats: { moveSpeedFlat: 50 },
    buildsFrom: [MID.bootsAttackSpeed],
    effects: {
      attackDamageFromMoveSpeed: 1,
      attackSpeedPctPerMoveSpeed: 0.01,
    },
    description: [
      "速度 +50",
      "被动：获得等同于当前移动速度的攻击力。",
      "被动：获得等同于当前移动速度%的攻击速度。",
      "合成：攻速鞋 + 1450 金币",
    ],
  },
  {
    ...
    effects: {
      ...
      witsHealPctOfOnHit: 0.5,
    },
    description: [
      "护甲 +45",
      "攻速% +45%",
      "智慧终结：普攻附带等同于 10% 当前护甲 + 10 的魔法伤害攻击特效。当生命值低于最大生命值的 50% 时，恢复等同于你造成攻击特效伤害 50% 的生命值。",
    ],
  },
  {
    ...
    iconFile: "纳什之牙.png",
    cost: 3000,
    stats: { attackSpeedPct: 0.50, abilityPowerFlat: 80 },
    ...
    description: [
      "法术强度 +80",
      "攻速% +50%",
      "啃咬：普攻命中敌方英雄时，造成 15（+50% 法术强度）的魔法伤害攻击特效。",
    ],
  },
  {
    ...
    cost: 3000,
    stats: { attackSpeedPct: 0.60 },
    buildsFrom: [MID.recurveBow, MID.recurveBow],
    effects: {
      ragebladeMagicOnHit: 60,
      extraOnHitEvery: 3,
      extraOnHitCount: 3,
      killAsStackPct: 0.10,
      killAsMaxStacks: 10,
      killAsDurationMs: 1000,
    },
    description: [
      "攻速% +60%",
      "怨怒：普攻附带 60 点魔法伤害攻击特效。每第三次普通攻击会额外附带 3 次攻击特效。",
      "沸腾打击：击杀单位会提供 10% 攻击速度，至多可叠加 10 次并至多提供 100% 攻击速度。该效果持续时间 1 秒，击杀敌人刷新持续时间。",
    ],
  },
  {
  ...
  },
  {
    ...
    effects: { burnTickMs: 100, burnBasePerTick: 1, burnApRatioPerTick: 0.0005, burnStacksOnMagicHit: true },
    description: [
      "法术强度 +75",
      "生命值 +300",
      "被动：对敌方单位造成法术伤害后，每 0.1 秒对其造成 1 + (法术强度 × 0.05%) 额外持续伤害直到敌方死亡。当敌方已有持续伤害，对其造成魔法伤害会额外将持续伤害增加 1 + (法术强度 × 0.05%)。",
    ],
  },
  {
  ...
  },
  {
    ...
    effects: { killCooldownRefundPct: 0.15 },
    description: [
      "法术强度 +65",
      "技能急速 +20",
      "生命值 +200",
      "被动：击杀单位立刻返还技能剩余冷却时间的 15%。",
    ],
  },
  {
    ...
    effects: {
      spellbladeBaseAdPct: 1.0,
      spellbladeMaxHpPct: 0.15,
      spellbladeMaxDamageBoss: 3000,
      spellbladeDamageType: "physical",
      spellbladeHealPctOfDamage: 1.0,
    },
    description: [
      "攻击力 +25",
      "技能急速 +25",
      "生命值 +500",
      "被动：施放技能后，下次普攻额外造成 100% 基础攻击力 + 敌人最大生命值 15% 的物理伤害（对 Boss 至多 3000），并治疗该被动造成伤害的等额生命值。",
    ],
  },
  {
  ...
  },
  {
    ...
    effects: {
      ...
      spellbladeApRatio: 2.0,
      spellbladeDamageType: "magic",
      spellbladeCharges: 3,
      spellbladeCooldownRefundPct: 0.15,
    },
    description: [
      "法术强度 +80",
      "技能急速 +10",
      "被动：施放技能后，下 3 次普攻额外造成 100% 攻击力 + 200% 法术强度的魔法伤害。每造成 1 次被动伤害，返还当前技能冷却时间的 15%。",
    ],
  },
  {
    ...
    effects: {
      spellbladeBaseAdPct: 1.0,
      spellbladeCanCrit: true,
      onHitTotalManaRestorePct: 0.05,
      spellbladeWindowMs: 3000,
      spellbladeDamageType: "physical",
    },
    description: [
      "攻击力 +35",
      "技能急速 +20",
      "暴击率 +25%",
      "被动：施放技能后，下次普攻额外造成 100% 基础攻击力的物理伤害，持续 3 秒，可暴击；普攻额外回复 5% 总法力值。",
    ],
  },
  {
    ...
    effects: {
      spellbladeAdRatio: 1.0,
      spellbladeArmorRatio: 5.0,
      spellbladeDamageType: "physical",
      frostfireAoERadiusBase: 100,
      frostfireAoERadiusArmorRatio: 0.80,
      frostfireArmorPerHitPct: 0.05,
      frostfireArmorBuffDurationMs: 3000,
    },
    description: [
      "技能急速 +30",
      "护甲 +50",
      "防御 +20",
      "生命值 +250",
      "被动：施放技能后，下次普攻额外造成 100% 攻击力 + 500% 护甲的范围物理伤害，并根据被动命中敌人数量提升 % 护甲（每命中一个提升 5%，持续 3 秒）。伤害范围半径随护甲而增大（100 + 护甲 ×80%）。",
    ],
  },
  {
  ...
  },
  {
    ...
    buildsFrom: [MID.cloakOfAgility, MID.recurveBow],
    effects: { boltCount: 3, boltDamageMultiplier: 0.55, boltsTriggerOnHit: true },
    description: [
      "攻速% +50%",
      "暴击率 +25%",
      "被动：每次普通攻击会额外发射 3 个弩箭，造成 55% 攻击力的物理伤害。这些弩箭可以触发攻击特效，也可以暴击。",
    ],
  },
  {
  ...
  },
  {
    ...
    effects: { frozenHeartEnemySlowPct: 0.50, frozenHeartBulletSlowPct: 0.50 },
    description: [
      "护甲 +75",
      "防御 +50",
      "生命值 +400",
      "被动：对所有受到伤害或对自己造成伤害的敌人减速 50%，弹幕减速 50%。",
    ],
  },
  {
    ...
    effects: { thornsArmorRatio: 0.50, thornsHealArmorRatio: 0.50 },
    description: [
      "护甲 +100",
      "被动：受到攻击时，对攻击者反弹并治疗自身 50% 护甲的魔法伤害。",
    ],
  },
  {
    key: LEGENDARY.qianbianzhejiaxiu,
    tier: ITEM_TIERS.LEGENDARY,
    name: "千变者甲修",
    intro: "高护甲成长",
    tags: ["护甲", "生命值"],
    ...
    iconFile: "千变者甲修.png",
    cost: 3000,
    stats: { arFlat: 80, hpFlat: 300, moveSpeedFlat: 50 },
    buildsFrom: [MID.bootsCloth],
    effects: { hpRegenPerSecond: 10, armorFromCurrentArmorPct: 0.30 },
    description: [
      "护甲 +80",
      "生命值 +300",
      "生命回复 +10/秒",
